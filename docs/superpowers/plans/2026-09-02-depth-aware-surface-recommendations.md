...
- [x] **Step 1: Generate deterministic acceptance artifacts**
...
- [x] **Step 2: Regenerate the cached real MSDL surface comparison**
...
- [x] **Step 3: Refresh the two static gallery images**
...
- [x] **Step 4: Visual QA at full resolution**
...
- [x] **Step 5: Validate manifests and commit generated evidence**
