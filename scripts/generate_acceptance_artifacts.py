...
def generate_artifacts(outdir: str | Path) -> dict[str, object]:
    ...
    results["surface_matplotlib"] = plot_connectome(
        ...
        geometry,
        views="paper",
        title="Simulated signed connectivity — paper",
        figsize=(14.0, 5.5),
        dpi=250,
    ...
    plot_connectome(
        ...
        style="paper",
        views="paper",
        title="User-provided full-resolution fsaverage — paper pial",
        figsize=(14.0, 5.5),
        dpi=250,
    ...
    results["surface_nilearn"] = plot_connectome(
        ...
        symmetric_cbar="auto",
        inflate=False,
        title="Simulated connectivity — native neutral pial three views",
        figsize=(10.0, 12.0),
        dpi=140,
    ...
    plot_connectome(
        ...
        geometry,
        views="whole",
        title="Simulated whole-brain views",
        figsize=(12.0, 5.5),
        dpi=160,
