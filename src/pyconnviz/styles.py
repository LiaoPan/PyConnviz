...
_STYLES: dict[str, dict[str, Any]] = {
    "paper": {
        ...
        "cortex_alpha": 0.24,
        "fixed_cortex_alpha": 0.08,
        "depth_cue_min_alpha": 0.70,
        "sulc_contrast": 0.55,
        "surface_cmap": "RdBu_r",
        "node_cmap": "viridis",
        "node_size_range": [24.0, 100.0],
        "fixed_node_diameter_range": [6.0, 16.0],
        "node_edgecolor": "white",
        "edge_cmap": "auto",
        "edge_width_range": [0.6, 4.0],
        "edge_alpha": 0.72,
        "fixed_edge_width_range": [1.4, 5.4],
        "fixed_edge_alpha": 0.95,
        "font_size": 10.0,
        "default_views": "paper",
    ...
    "soft": {
        ...
        "edge_alpha": 0.58,
        "fixed_edge_width_range": [1.3, 5.0],
        "fixed_edge_alpha": 0.90,
        "font_size": 10.0,
        "default_views": "paper",
        "default_overlay": "none",
    },
    "dark": {
        ...
        "edge_alpha": 0.82,
        "fixed_edge_width_range": [1.4, 5.6],
        "fixed_edge_alpha": 0.96,
        "font_size": 10.0,
        "default_views": "paper",
        "default_overlay": "none",
    },
